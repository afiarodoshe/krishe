...
private FirebaseRecyclerAdapter adapter;
    ...
    private void populateRecyclerView() {
        ...
        //Say Hello to our new FirebaseUI android Element, i.e., FirebaseRecyclerAdapter
         FirebaseRecyclerAdapter<SingleProductModel, MovieViewHolder> adapter;
        //
     mDatabaseReference = FirebaseDatabase.getInstance().getReference().child("cart");
        Query personsQuery = mDatabaseReference.orderByKey();

        mRecyclerView.hasFixedSize();
        mRecyclerView.setLayoutManager(new LinearLayoutManager(Cart.this));

        FirebaseRecyclerOptions personsOptions = new FirebaseRecyclerOptions.Builder<SingleProductModel>().setQuery(personsQuery, SingleProductModel.class).build();

        adapter = new FirebaseRecyclerAdapter<SingleProductModel, MovieViewHolder>(personsOptions) {
            @Override
            protected void onBindViewHolder(final MovieViewHolder viewHolder,final int position,final SingleProductModel model) {
